...
.Figure 1: a sample application theme called [filename]#my-theme#
[source, filesystem]
----
frontend/
└── themes/ <1>
...
<8> Theme configurations (for example assets from `node_modules` or <<Extending an Existing Application Theme,parent theme>> properties) are defined in this file.
